...
export const MITIGATION_TEMPLATES: readonly MitigationTemplate[] = [
  ...
  },
  {
    ...
    exploitSignals: ["mass assignment", "privileged field accepted", "role=admin"],
    protectionSignals: ["privileged fields stripped", "rejected", "400"],
    defaultSeverity: "high",
  },
  {
  ...
  },
  {
    ...
    exploitSignals: ["missing csp", "missing hsts", "missing content-security-policy"],
  ...
  },
  {
    ...
    exploitSignals: ["ssrf", "internal fetch", "169.254.169.254", "metadata url"],
    protectionSignals: ["blocked by allowlist", "internal fetch: false"],
    defaultSeverity: "high",
  },
  {
    ...
    exploitSignals: ["cors", "allow-origin: *", "wildcard with credentials"],
    protectionSignals: ["cors restricted", "explicit allowlist"],
    defaultSeverity: "medium",
  },
] as const;
