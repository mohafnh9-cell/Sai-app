...
/**
 * ADR-001 / MCP V1 + RT2: nine public tools including discover_application, full_product_audit, and authorize_dynamic_target.
 */
describe("MCP public tool surface", () => {
  it("registers exactly nine public tools", () => {
