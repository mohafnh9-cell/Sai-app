...
import { attackExecutionRunFunction } from "@/inngest/functions/attack-execution-run";
...
console.info({
  ...
  functionIds: ["scan-run", "attack-execution-run", "process-github-webhook", "scan-job-recovery"],
});
