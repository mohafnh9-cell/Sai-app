...
const cicdExtended = [
  ...
  patternRule("cicd.github-actions-supply-chain", "GitHub Actions supply-chain hardening", [{
    ...
    description:
      "The workflow references an action by a tag or branch (e.g. @v4, @main) instead of a commit SHA. Tags and branches can be repointed by the action's maintainer or an attacker who compromises them — the exact vector used in real supply-chain attacks like the 2025 tj-actions/changed-files compromise.",
    severity: "medium",
    confidence: "medium",
    category: "cicd",
